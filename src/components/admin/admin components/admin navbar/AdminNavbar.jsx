      ...
      <nav className="navbar navbar-expand-lg">
        <div className="container">
          <Link className=" navbar-brand py-0 me-3" to="/">
            <img className="navbar-brand-item light-mode-item" alt="logo" src="/assets/images/wlcm21.png"
            ...
            <ul className="navbar-nav navbar-nav-scroll mx-auto">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/about-us">
                  <i className="bi bi-people me-1" /> About us
                </Link>
              </li>
              <li className="nav-item">
              ...
              <ul
                ...
                <li>
                  <Link className="dropdown-item" to="/user">
                    <i className="bi bi-person fa-fw me-2" /> Profile
                  </Link>
                </li>
                <li>
                  <a className="dropdown-item" href="/user/edit_details">
                    <i className="bi bi-gear fa-fw me-2" /> Edit Details
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="/contact-us">
                    <i className="bi bi-info-circle fa-fw me-2" /> Help
                  </a>
                </li>
                <li className="dropdown-divider mb-3" />
                <li>
                  <a className="dropdown-item" href="#">
                    <i className="bi bi-power fa-fw me-2" />Sign Out
                  </a>
                </li>
              </ul>
            </div>
