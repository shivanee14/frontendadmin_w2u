...
import HeaderOffcanvas from "./header offcanvas/HeaderOffcanvas";
...
function IndexHeader() {
  ...
  return (
    <>
        ...
        <div className="navbar-top small">
          <div className="container-fluid px-3 hom-top">
            ...
            >
              ...
              {/* logo section   */}
              <div className="logowlcm d-flex pb-lg-2">
                <Link to="/">
                  <img
                    className="mx-auto"
              ...
              <div className="d-flex">
                ...
                {UserSignedin ? (
                  ...
                  <div className="nav-item my-1">
                    <Link
                      to="/signin"
                      className="btn btn-sm btn-secondary mb-0 mx-2"
                    >
                      + Add Listing
                    </Link>
                  </div>
      ...
      {/* <div className="modal fade" id="myModalj">
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">Jagdish Mandir Live Darshan</h4>
              <button
                type="button"
                className="btn-close"
                data-bs-dismiss="modal"
      ...
      {/* <div className="modal fade" id="myModals">
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">Sagas Ji Live Darshan</h4>
              <button
                type="button"
                className="btn-close"
                data-bs-dismiss="modal"
      ...
      <div className="modal fade" id="myModaln">
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">Nathdwara Live Darshan</h4>
              <button
                type="button"
                className="btn-close"
                data-bs-dismiss="modal"
      ...
      <div className="modal fade" id="myModale">
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">Ekling Ji Live Darshan</h4>
              <button
                type="button"
                className="btn-close"
                data-bs-dismiss="modal"
